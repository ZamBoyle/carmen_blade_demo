<x-modele>
    <x-slot name="title">A.S.B.L. VOY - Contact</x-slot>
    <x-slot name="footer">
    ...
    <ul>
        <li><i class="bi bi-facebook" aria-label="Icone Facebook"></i><a target="_blank" rel="noopener noreferrer"
                href="https://www.facebook.com/profile.php?id=100039993684062">Facebook Cécifoot Standard de Liège</a>
        </li>
        <li><i class="bi bi-instagram"></i><a rel="noopener noreferrer"
                href="https://www.instagram.com/standard_cecifoot/" target="_blank">Instagram standard_cecifoot : </a>
        </li>
