    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('history') }}">Notre histoire</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('goals') }}">Nos objectifs</a></li>
                <li class="nav-item"><a class="nav-link" href="support">Comment nous
                        soutenir ?</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="organigram">Organigramme de l'association</a></li>
                <li class="nav-item"><a class="nav-link" href="contact">Contact</a></li>
                <li class="nav-item"><a class="nav-link" href="galery">Gallerie photo</a></li>
            </ul>
        </div>
    </div>
</nav> --}}
